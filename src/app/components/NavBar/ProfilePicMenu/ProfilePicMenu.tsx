  ...
  return (
    <>
      {open && (
        <div
          className={twMerge(
            "absolute  dark:bg-darkGray dark:shadow-none shadow-[0px_0px_42px_0px_#00000024] bg-lightHomeBg max-h-[calc(100vh_-_3.75rem)]  py-4   z-10 rounded-xl text-[0.875rem] overflow-y-auto",
            type === "Desktop" ? "top-[2.4rem] w-[20rem] right-0" : "top-[3rem] w-[16rem] right-4"
          )}
          ref={menuRef}
        >
          {/* Content */}
